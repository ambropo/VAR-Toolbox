function SRout = SR_OLD(VAR,R,VARopt)
% =======================================================================
...
%     VAR_draw = VAR;
    ...
    [IRF_draw, VAR_draw] = VARir_OLD(VAR_draw,VARopt);
    ...
    if min(min(checkall))==1
        jj = jj+1 ;
        [aux_irf, VAR_draw] = VARir_OLD(VAR_draw,VARopt); 
        IRFstore(:,:,:,jj)  = aux_irf;
        % FEVD
        aux_fevd = VARfevd_OLD(VAR_draw,VARopt);
