function [SRout, flag] = SR_COVID(VAR,SIGN,VARopt)
% =========================================================================
...
while jj < ndraws
    ...
    [B, flag] = SignRestrictions_COVID(SIGN,VAR_draw,VARopt); % Note: e = (inv(B)*VAR_draw.resid')';
...
%==========================================================================
if flag==1
    SRout.IR = nan(VARopt.nsteps,VAR.nvar,VAR.nvar);
else
    ...
    format long 
    aux = sum(sum(abs(Ball-SRout.Bmed),1),2);
